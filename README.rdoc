...
Ruby.d (bcd/Ruby/ruby.d) file and dexter_bcd.d in a state that compiles, runs and passes tests. Working (proved) ruby C functions: * rb_define_class, rb_define_method, rb_define_module, rb_define_module_function
* rb_intern, rb_funcall
* rb_num2long, rb_int2inum
* rb_iv_get, rb_iv_set
* rb_string_value, rb_str_new, rb_ary_new
