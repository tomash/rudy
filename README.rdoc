...
Ruby.d (bcd/Ruby/ruby.d) file and dexter_bcd.d in a state that compiles, runs and passes tests. Working (proved) ruby C functions: rb_define_class, rb_define_module, rb_define_method.
...
* Kirk McDonald - lots of help and advice on D and interaction with Ruby, original author of PyD
* Ray C. Horn and "cpunion" - inspiration
